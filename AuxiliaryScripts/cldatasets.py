...
def get_splitCIFAR(seed=0, pc_valid=0.10, task_num = 0, split=""):
    ...
    if os.path.isfile(("../data/split_cifar/" + str(task_num) + "/x_train.bin")) == False:
        print("No dataset detected for split_cifar. Creating new set prior to loading task.")
...
########################################
###  Dataset Creation
###  Note: Tiny Imagenet and KEF MNIST datasets are made through the accompanying ipynb as their setup is more involved
########################################
